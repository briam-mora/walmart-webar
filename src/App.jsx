    ...
    <AudioProvider>
      <>
        ...
        <a-scene loading-screen="dotsColor: #ffc21f; backgroundColor: #0071ce" 
                 ...
                 renderer="precision: medium; antialias: false; alpha: false; stencil: false; depth: true; logarithmicDepthBuffer: false"
                 webgl="antialias: false; alpha: false; depth: true; stencil: false; preserveDrawingBuffer: false; logarithmicDepthBuffer: false; powerPreference: default; failIfMajorPerformanceCaveat: false"
          ...
          <a-assets timeout="30000">
            ...
            {content.images.map(image => <img key={image.id} id={image.id} src={image.src} crossOrigin="anonymous" preload="none" />)}
            {content.memory.map(card => <img key={card.id} id={card.id} src={card.src} crossOrigin="anonymous" preload="none" />)}
            {content.memory_win.map(card => <img key={card.id} id={card.id} src={card.src} crossOrigin="anonymous" preload="none" />)}
            {content.globos.map(globo => <img key={globo.id} id={globo.id} src={globo.src} crossOrigin="anonymous" preload="none" />)}
            {content.plataforma.map(plataforma => <img key={plataforma.id} id={plataforma.id} src={plataforma.src} crossOrigin="anonymous" preload="none" />)}
            <img id="light-arrow" src="icono.png" crossOrigin="anonymous" preload="none" />
            <img id="play-button" src="play.png" crossOrigin="anonymous" preload="none" />
            <img id="pantalla-carga" src="walmart_start.png" crossOrigin="anonymous" preload="none" />
            <img id="celular" src="celular.png" crossOrigin="anonymous" preload="none" />
            <img id="celular-flechas" src="celular-flechas.png" crossOrigin="anonymous" preload="none" />
            <img id="celular-instrucciones" src="celular-instrucciones.png" crossOrigin="anonymous" preload="none" />
            <img id="next" src="next.png" crossOrigin="anonymous" preload="none" />
            <img id="prev" src="prev.png" crossOrigin="anonymous" preload="none" />
            <img id="close" src="close.png" crossOrigin="anonymous" preload="none" />
            <img id="cardback" src="cardback.png" crossOrigin="anonymous" preload="none" />
            <video id="video" src="video.mp4" autoPlay={false} loop={false} preload="none" controls={false}></video>
            <audio id="click" src="click.wav" preload="none"></audio>
